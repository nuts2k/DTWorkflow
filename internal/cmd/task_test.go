...
func (m *mockTaskStore) FindActiveIssueTasks(_ context.Context, _ string, _ int64, _ model.TaskType) ([]*model.TaskRecord, error) {
	return nil, nil
}
...
// UpdateTestGenResultReviewEnqueued M4.2 I6 partial UPDATE 语义；mock 桩 no-op。
func (m *mockTaskStore) UpdateTestGenResultReviewEnqueued(_ context.Context, _ string) error {
	return nil
}
...
func (m *mockTaskStore) GetIterationRound(_ context.Context, _ int64, _ int) (*store.IterationRoundRecord, error) {
	return nil, nil
}
...
func (m *mockTaskStore) GetCompletedRoundsForSession(_ context.Context, _ int64) ([]*store.IterationRoundRecord, error) {
	return nil, nil
}
